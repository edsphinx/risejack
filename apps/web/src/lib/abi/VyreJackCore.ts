export const VYREJACKCORE_ABI = [
  {
    inputs: [
      ...
      { internalType: 'address', name: '_casino', type: 'address' },
    ],
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'isDealer', type: 'bool' },
      { indexed: false, internalType: 'bool', name: 'faceUp', type: 'bool' },
    ],
    name: 'CardDealt',
    type: 'event',
  },
  {
    anonymous: false,
    inputs: [
      { indexed: true, internalType: 'address', name: 'oldCasino', type: 'address' },
      { indexed: true, internalType: 'address', name: 'newCasino', type: 'address' },
    ],
    name: 'CasinoChanged',
    type: 'event',
  },
  {
    ...
    inputs: [
      { indexed: true, internalType: 'address', name: 'player', type: 'address' },
      { indexed: false, internalType: 'uint8', name: 'finalValue', type: 'uint8' },
    ],
    name: 'DealerBusted',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'uint256', name: 'payout', type: 'uint256' },
      { indexed: false, internalType: 'uint8', name: 'playerFinalValue', type: 'uint8' },
      { indexed: false, internalType: 'uint8', name: 'dealerFinalValue', type: 'uint8' },
    ],
    name: 'GameResolved',
    type: 'event',
  },
  ...
  },
  {
    ...
    inputs: [
      ...
      { indexed: false, internalType: 'bool', name: 'isSoft', type: 'bool' },
      { indexed: false, internalType: 'bool', name: 'isDealer', type: 'bool' },
    ],
    name: 'HandValue',
    type: 'event',
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'bool', name: 'isSoft', type: 'bool' },
    ],
  ...
  },
  {
    inputs: [],
    name: 'coordinator',
    outputs: [{ internalType: 'contract IVRFCoordinator', name: '', type: 'address' }],
    stateMutability: 'view',
    type: 'function',
  },
  {
  ...
  },
  {
    ...
    outputs: [
      ...
      { internalType: 'enum VyreJackCore.GameState', name: 'state', type: 'uint8' },
      { internalType: 'uint256', name: 'timestamp', type: 'uint256' },
      { internalType: 'bool', name: 'isDoubled', type: 'bool' },
    ],
    stateMutability: 'view',
    type: 'function',
  },
    ...
    inputs: [
      { internalType: 'address', name: 'player', type: 'address' },
      {
        components: [
          ...
          { internalType: 'uint8', name: 'chipTier', type: 'uint8' },
        ],
  ...
  {
    inputs: [{ internalType: 'address', name: '_casino', type: 'address' }],
    name: 'setCasino',
    outputs: [],
    stateMutability: 'nonpayable',
    type: 'function',
  ...
  },
  {
    ...
    outputs: [
      { internalType: 'address', name: 'player', type: 'address' },
      { internalType: 'enum VyreJackCore.RequestType', name: 'requestType', type: 'uint8' },
