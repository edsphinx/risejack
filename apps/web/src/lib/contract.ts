 ...
 * 
 * VyreJack contract address and ABI configuration.
...
const DEFAULT_VYREJACK_ADDRESS = '0xe17C645aE8dC321B41BA00bbc8B9E392342A0cA2' as Address;

/**
 * Get VyreJack contract address from environment or use default
 */
export function getVyreJackAddress(): Address {
    ...
    return DEFAULT_VYREJACK_ADDRESS;
}
