 ...
 * @notice Dedicated referral system with multi-tier earnings
 * @dev Handles referral relationships and revenue sharing
 *
 * MULTI-TIER SYSTEM:
 * - Level 1 (Direct): 50% of house edge share
 * - Level 2 (Indirect): 10% of house edge share
 *
 * Example: Player A refers Player B, Player B refers Player C
 * - When C plays and house earns 100 CHIP edge:
 *   - B (direct referrer) gets 50 CHIP
 *   - A (indirect referrer) gets 10 CHIP
 */
