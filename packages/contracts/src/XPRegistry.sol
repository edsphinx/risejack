...
/**
 * @title XPRegistry
 * @notice Tracks player XP and levels for the casino ecosystem
 * @dev Used by TokenFactory to verify Level 50 for token creation
 *
 * LEVEL THRESHOLDS:
 ...
 * Level 60+: 100,000 + (level-50) * 50,000
 */
contract XPRegistry {
    // ==================== STATE ====================
