...
contract RiseCasinoERC20 {
    string public constant name = "RiseCasino LP";
    string public constant symbol = "RSC-LP";
    ...
    function permit(
        ...
        require(deadline >= block.timestamp, "RiseCasino: EXPIRED");
...
contract RiseCasinoPair is RiseCasinoERC20 {
    ...
    modifier lock() {
        require(unlocked == 1, "RiseCasino: LOCKED");
        unlocked = 0;
        _;
        unlocked = 1;
    }
    ...
    function burn(address to) external lock returns (uint256 amount0, uint256 amount1) {
        ...
        require(amount0 > 0 && amount1 > 0, "RiseCasino: INSUFFICIENT_LIQUIDITY_BURNED");
...
contract RiseCasinoFactory {
    ...
    function createPair(address tokenA, address tokenB) external returns (address pair) {
        ...
        RiseCasinoPair(pair).initialize(token0, token1);
